...
function mapServerChatMessage(message: ServerRoomMessage, currentUserId?: string): ChatMessage {
  ...
  if (message.kind === 'system') {
    const event: ChatMessage['event'] = message.body.includes('하트')
      ? 'heart'
